...
- **Fakturering** — löpande nummerserie (obruten enligt bokföringslagen), egen HTML-mall eller standardmall; fakturafilen arkiveras som den skapades och laddas ned lokalt; skicka via e-post/dela/utskrift; registrera betalning bokför enligt faktura- eller kontantmetoden
...
```bash
npm run test          # 492 enhetstester (tsx + fake-indexeddb)
